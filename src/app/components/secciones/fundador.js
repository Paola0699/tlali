...
const paddingValue = isMdAndLg ? 15 : 8;
  return (
    <Grid id={id} container style={{backgroundColor: '#D7C6A7'}} marginBottom={3}>
        <Grid item xs={12} padding={paddingValue}>
            <FundadorImagen/>
            <FundadorQuote descripcion={'“Tlali existe para fortalecer e impulsar el talento y cultura que México tiene para ofrecer al mundo. Estamos tan acostumbrados a lo Mexicano, que se nos olvida lo increíble que es nuestro país y queremos parecernos a los gringos o europeos, cuando nuestra cultura no le pide nada a nadie, solo nos falta un empujoncito, para tener el país que merecemos los mexicanos”'}/>
